  ...
  <div class="container d-flex justify-content-center align-items-center min-vh-100">
    ...
    <div class="row border rounded-5 p-3 bg-white shadow box-area">
      ...
      <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
        style="background: #ec985a">
        <div class="featured-image mb-3 mt-3">
          <img src="../img/LgnBnnr.jpg" class="img-fluid" style="width: 250px" />
        </div>
        ...
        <small class="text-white text-wrap text-center"
          style="width: 17rem; font-family: 'Courier New', Courier, monospace">batik with the best quality, customer
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            <button class="btn btn-lg btn-light w-100 fs-6">
              <img src="../img/Logo1.svg" style="width: 50px" class="me-2" /><small>Join to become a traditional batik
                admin</small>
            </button>
          </div>
        </form>
