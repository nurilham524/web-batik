...
<html lang="en">
  ...
  <body>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../assets/bg1n.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../assets/bg5.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            ...
            <div class="row mt-3">
                <div class="col-4">
                    <a href="https://wa.me/6285656804903?text=hi%20admin,%20I%20want%20to%20order%20a%20model%20of%201%20batik%20wrap%20skirt!">
                      <img src="../assets/model1.jpg" class="img-thumbnail" alt="Rok batik1"></a>
                    <p class="text-center mt-3">Rok Lilit Batik - Model 1</p>
                    <p class="text-center">Harga : <?php
                        $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE id_produk=1001");
                        $dataProduk = mysqli_fetch_assoc($queryProduk);
                        ?>
                        <?php echo $dataProduk['harga_produk'] ?></p>
                </div>
                <div class="col-4">
                    <a href="https://wa.me/6285656804903?text=hi%20admin,%20I%20want%20to%20order%20a%20model%20of%202%20batik%20wrap%20skirt!">
                    <img src="../assets/model2.jpg" class="img-thumbnail" alt="Rok batik2">
                  </a>
                    <p class="text-center mt-3">Rok Lilit Batik - Model 2</p>
                    <p class="text-center">Harga : <?php
                        $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE id_produk=1002");
                        $dataProduk = mysqli_fetch_assoc($queryProduk);
                        ?>
                        <?php echo $dataProduk['harga_produk'] ?></p>
                </div>
                <div class="col-4">
                    ...
                    <img src="../assets/model3.jpg" class="img-thumbnail" alt="Rok batik3"></a>
                    <p class="text-center mt-3">Rok Lilit Batik - Model 3</p>
                    <p class="text-center">Harga : <?php
                        $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE id_produk=1003");
                        $dataProduk = mysqli_fetch_assoc($queryProduk);
                        ?>
                        <?php echo $dataProduk['harga_produk'] ?></p>
                </div>
          ...
          <div class="row">
            <div class="col-4">
              <a href="https://wa.me/6282353259571?text=hi%20admin,%20I%20want%20to%20order%20model%201%20batik%20bag!">
                <img src="../assets/tas1.jpg" class="img-thumbnail" alt="Tas batik1"></a>
              <p class="text-center mt-3">Tas Batik - Model 1</p>
              <p class="text-center">Harga : <?php
                        $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE id_produk=2001");
                        $dataProduk = mysqli_fetch_assoc($queryProduk);
                        ?>
                        <?php echo $dataProduk['harga_produk'] ?></p>
            </div>
            <div class="col-4">
              <a href="https://wa.me/6282353259571?text=hi%20admin,%20I%20want%20to%20order%20model%202%20batik%20bag!">
                <img src="../assets/tas2.jpg" class="img-thumbnail" alt="Tas batik2"></a>
              <p class="text-center mt-3">Tas Batik - Model 2</p>
              <p class="text-center">Harga : <?php
                        $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE id_produk=2002");
                        $dataProduk = mysqli_fetch_assoc($queryProduk);
                        ?>
                        <?php echo $dataProduk['harga_produk'] ?></p>
            </div>
            <div class="col-4">
              <a href="https://wa.me/6282353259571?text=hi%20admin,%20I%20want%20to%20order%20model%203%20batik%20bag!">
                <img src="../assets/tas3.jpg" class="img-thumbnail" alt="Tas batik3"></a>
              <p class="text-center mt-3">Tas Batik - Model 3</p>
              <p class="text-center">Harga : <?php
                        $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE id_produk=2003");
                        $dataProduk = mysqli_fetch_assoc($queryProduk);
                        ?>
                        <?php echo $dataProduk['harga_produk'] ?></p>
            </div>
          ...
          <div class="row">
            <div class="col-4">
              <a href="https://wa.me/6282353259571?text=hi%20admin,%20I%20want%20to%20order%20batik%20couple%20model%201!">
                <img src="../assets/baju1.jpeg" class="img-thumbnail" alt="Baju batik1">
              </a>
              <p class="text-center mt-3">Baju Couple Batik - Model 1</p>
              <p class="text-center">Harga : <?php
                        $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE id_produk=3001");
                        $dataProduk = mysqli_fetch_assoc($queryProduk);
                        ?>
                        <?php echo $dataProduk['harga_produk'] ?></p>
            </div>
            <div class="col-4">
              <a href="https://wa.me/6282353259571?text=hi%20admin,%20I%20want%20to%20order%20batik%20couple%20model%202!">
                <img src="../assets/baju2.jpg" class="img-thumbnail" alt="Baju batik2">
              </a>
              <p class="text-center mt-3">Baju Couple Batik - Model 2</p>
              <p class="text-center">Harga : <?php
                        $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE id_produk=3002");
                        $dataProduk = mysqli_fetch_assoc($queryProduk);
                        ?>
                        <?php echo $dataProduk['harga_produk'] ?></p>
            </div>
            <div class="col-4">
              <a href="https://wa.me/6282353259571?text=hi%20admin,%20I%20want%20to%20order%20batik%20couple%20model%203!">
                <img src="../assets/baju3.jpg" class="img-thumbnail" alt="Baju batik3">
              </a>
              <p class="text-center mt-3">Baju Couple Batik - Model 3</p>
              <p class="text-center">Harga : <?php
                        $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE id_produk=3003");
                        $dataProduk = mysqli_fetch_assoc($queryProduk);
                        ?>
                        <?php echo $dataProduk['harga_produk'] ?></p>
            </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#eaeaea" fill-opacity="1" d="M0,160L30,176C60,192,120,224,180,213.3C240,203,300,149,360,138.7C420,128,480,160,540,149.3C600,139,660,85,720,64C780,43,840,53,900,64C960,75,1020,85,1080,106.7C1140,128,1200,160,1260,165.3C1320,171,1380,149,1410,138.7L1440,128L1440,320L1410,320C1380,320,1320,320,1260,320C1200,320,1140,320,1080,320C1020,320,960,320,900,320C840,320,780,320,720,320C660,320,600,320,540,320C480,320,420,320,360,320C300,320,240,320,180,320C120,320,60,320,30,320L0,320Z"></path></svg>
  </section>
      ...
      <h1 class="display-4 text-center" id="about">OUR HISTORY</h1>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-4">
              <figure class="figure">
                <img src="../assets/owner1.jpeg" width="400" class="rounded-circle float-start mb-3 img-fluid" alt="Muh nur ilham nurdin">
                <figcaption class="figure-caption text-center">MUH. NUR ILHAM NURDIN.</figcaption>
              </figure>
            </div>
            <div class="col-4">
              <figure class="figure">
                <img src="../assets/owner2.jpg" width="400" class="rounded-circle float-start mb-3 img-fluid" alt="Muhammad azis">
        ...
        <div class="container text-center">
         ...
         <div class="container">
          <div class="row">
            <div class="col-4">
              <div class="card">
                <img src="../assets/promo2.png" class="card-img-top" alt="promo2">
                <div class="card-body">
            ...
            <div class="col-4">
              <div class="card">
                <img src="../assets/promo1.png" class="card-img-top" alt="promo1">
                <div class="card-body">
            ...
            <div class="col-4">
              <div class="card">
                <img src="../assets/promo3.png" class="card-img-top" alt="promo3">
                <div class="card-body">
      ...
      <footer class="pt-5 pb-4">
        <div class="container text-center text-md-left">
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
            ...
            <p>
              <a href="#" class="text-dark" style="text-decoration: none;">Produk</a>
            </p>
            <p>
